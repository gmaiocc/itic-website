  ...
  const activities = [
    {
      ...
      desc: "We oversee ITIC's public image, managing social media strategies and ensuring clear, impactful communication across all channels."
    },
    {
      icon: Users,
      title: "Recruitment Leadership",
      desc: "We lead the recruitment processes from start to finish, ensuring we attract top talent and integrate new members effectively."
    },
    {
      icon: Handshake,
      title: "Internal Collaboration",
      desc: "We strengthen collaboration within the club and manage relationships with external partners to create value for our members."
    },
    {
      icon: Award,
      title: "Organizational Excellence",
      desc: "We ensure everything runs smoothly behind the scenes, guaranteeing a positive and professional experience for every club member."
    }
  ];

  const tools = [
    { name: "Brand Management", icon: Layout },
      ...
      <div className="min-h-screen bg-white font-sans overflow-x-hidden">
        ...
        <main>
          ...
          <section className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden pt-24 pb-12 lg:pt-20 lg:pb-20">
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                >
                  ...
                  <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-8 border-l-0 lg:border-l-4 border-red-600 lg:pl-6 px-2 lg:px-0">
                    The backbone of ITIC. We oversee communication, lead
                    recruitment, and ensure organizational excellence for a
                    world-class club experience.
                  </p>
            ...
            {/* CORREÇÃO AQUI:
              1. Alterado bottom-10 para bottom-24 em desktop (lg) para não sobrepor a barra.
              2. Aumentado z-20 para z-30 para garantir que fica ACIMA da barra escura.
            */}
            <motion.div
              initial={{ opacity: 0 }}
                ...
                >
                  <div className="relative aspect-[3/4] rounded-2xl md:rounded-[2rem] overflow-hidden shadow-2xl shadow-gray-200 border border-gray-100">
                    ...
                    <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white">
                      ...
                      <h2 className="text-2xl md:text-3xl font-bold">Margarida Balau</h2>
                    </div>
                  </div>
                ...
                >
                  <div>
                    <h3 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6 md:mb-8 text-center lg:text-left">
                      Driving Excellence & <br className="hidden lg:block"/> Collaboration
                    </h3>
                    ...
                    <div className="relative pl-6 md:pl-8 border-l-4 border-red-500 max-w-xl mx-auto lg:mx-0">
                      ...
                      <p className="text-lg md:text-xl text-gray-800 italic leading-relaxed mb-6 font-medium">
                        "At Operations Department, we handle communication, recruit and onboard members, and keep everything running smoothly for the best club experience."
                      </p>
                    </div>

                    <p className="text-base md:text-lg text-gray-600 leading-relaxed text-justify lg:text-left">
                      Margarida leads the team that keeps ITIC moving. From managing our public brand to ensuring internal cohesion, Operations is the glue that connects strategy to execution.
                    </p>
                  </div>

                  <div className="grid grid-cols-3 gap-2 md:gap-6 pt-8 border-t border-gray-100 text-center lg:text-left">
                    <div>
                      <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">100%</div>
                      <div className="text-[10px] md:text-xs text-red-600 font-bold uppercase tracking-wider mt-1">Brand Consistency</div>
                    </div>
                    <div>
                      <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">HR</div>
                    ...
                    <div>
                      ...
                      <div className="text-[10px] md:text-xs text-red-600 font-bold uppercase tracking-wider mt-1">Members Managed</div>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="text-center mb-12 md:mb-20">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
                  Ensuring efficiency and growth throughout the semester.
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      text: "We lead the recruitment drives to select the best talent and ensure their smooth integration into the club's culture."
                    },
                    {
                      step: "02",
                      title: "Communication Strategy",
                      text: "We manage social media, PR, and internal channels to maintain a strong, consistent, and professional brand image."
                    },
                    {
                      step: "03",
                      title: "Event & Team Management",
                      text: "We organize events, foster partnerships, and manage feedback loops to continuously improve the member experience."
                    }
                  ].map((phase, i) => (
                    <motion.div
                      key={i}
