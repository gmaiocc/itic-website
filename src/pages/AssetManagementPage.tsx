...
const AssetManagementPage = () => {
  ...
  return (
    <PageTransition>
      {/* Adicionado overflow-x-hidden para prevenir scroll lateral */}
      <div className="min-h-screen bg-white font-sans overflow-x-hidden">
        <Navbar />

        <main>
          {/* HERO SECTION */}
          {/* Ajustado para min-h-[100dvh] e paddings responsivos */}
          <section className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden pt-24 pb-12 lg:pt-20 lg:pb-20">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 flex-grow flex flex-col justify-center pb-24">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                >
                  ...
                  {/* Fonte responsiva ajustada (Clamp) */}
                ...
                {/* Container do Globo ajustado para alturas flexíveis */}
                <motion.div
            ...
            {/* CORREÇÃO DO BUG "MEET THE TEAM" + Z-INDEX */}
            <motion.div
              initial={{ opacity: 0 }}
          ...
          >
            {/* Background Decor - Oculto em mobile para evitar bugs de layout */}
                ...
                >
                  <div className="relative aspect-[3/4] rounded-2xl md:rounded-[2rem] overflow-hidden shadow-2xl shadow-gray-200 border border-gray-100">
                    ...
                    <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white">
                      ...
                      <h2 className="text-2xl md:text-3xl font-bold">Vasco Fontes</h2>
                    </div>
                  </div>
                  
                  {/* Decorative Elements - Ajustados para mobile */}
                ...
                >
                  <div>
                    <h3 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6 md:mb-8 text-center lg:text-left">
                      From Analysis to <br className="hidden lg:block"/> Portfolio Decisions
                    </h3>
                  ...
                  {/* Stats Grid - Ajustado para mobile */}
                  <div className="grid grid-cols-3 gap-2 md:gap-6 pt-8 border-t border-gray-100 text-center lg:text-left">
                    <div>
                      ...
                      <div className="text-[10px] md:text-xs text-red-600 font-bold uppercase tracking-wider mt-1">Years Experience</div>
                    </div>
                    <div>
                      <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Valuation</div>
                      <div className="text-[10px] md:text-xs text-red-600 font-bold uppercase tracking-wider mt-1">Core Specialty</div>
                    </div>
                    <div>
                      <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">10+</div>
                      <div className="text-[10px] md:text-xs text-red-600 font-bold uppercase tracking-wider mt-1">Team Members</div>
                    </div>
                  </div>
                </motion.div>
              </div>
