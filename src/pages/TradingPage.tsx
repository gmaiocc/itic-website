...
import tradingheadv3 from "@/assets/tradingheadv3.png";

const TRADING_HERO_BG =
  ...
  const activities = [
    {
      ...
      desc: "We learn how to manage risk effectively to ensure safe and consistent trades, prioritizing capital preservation above all else."
    },
    {
      icon: BrainCircuit,
      title: "Quantitative Strategies",
      desc: "We develop outperforming quantitative strategies by backtesting data and applying statistical methods to find market edge."
    },
    {
      icon: Activity,
      title: "Market Outlooks",
      desc: "We follow the markets closely with weekly recaps and clear outlooks, identifying multi-month winning stocks and trends."
    },
    {
      icon: Trophy,
      title: "Competition Training",
      desc: "We train rigorously to compete in national and international investment challenges and finance competitions."
    }
  ];
                  ...
                  {[
                    {
                      step: "01",
                      title: "Analyze & Plan",
                      text: "We review weekly market structure, liquidity levels, and macro news to map out high-probability scenarios."
                    },
                    {
                      step: "02",
                      title: "Execute & Manage",
                      text: "We execute trades with precision, strictly adhering to pre-defined risk parameters to protect capital."
                    },
                    {
                      step: "03",
                      title: "Review & Improve",
                      text: "We journal every trade and review performance metrics to plug leaks and continuously refine our edge."
                    }
                  ].map((phase, i) => (
                    <motion.div
                      key={i}
