...
import { 
  Target, LineChart, Trophy, BrainCircuit, Activity, Monitor, 
  Terminal, BarChart4, ArrowRight, ChevronDown 
} from "lucide-react";
...
const TRADING_HERO_BG = "https://images.unsplash.com/photo-1611974765270-ca12586343bb?q=80&w=2070&auto=format&fit=crop";

const TradingPage = () => {
  const canvasRef = useRef<HTMLCanvasElement>(null);

  // Configuração do Globo (Apenas Visual, Sem Interação)
  useEffect(() => {
    let phi = 0;
    let width = 0;
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      mapSamples: 14000,
      mapBrightness: 6,
      baseColor: [0.8, 0.1, 0.1], // Vermelho
      markerColor: [0.8, 0.1, 0.1],
      glowColor: [1, 0.5, 0.5], 
      opacity: 0.6, // Opacidade a 60% como pedido
      markers: [],
      onRender: (state) => {
        // Apenas rotação automática
        phi += 0.003;
        state.phi = phi;
        state.width = width * 2;
  ...
  const activities = [
    {
      icon: Target,
      title: "Sunday Scan",
      desc: "Weekly prep session. We review macro events, identify key liquidity levels, and map out high-probability scenarios for the week ahead."
    },
    {
      icon: BrainCircuit,
      title: "Quantitative Strategies",
      desc: "Development of data-driven approaches. We use backtesting and statistical metrics to build robust, rule-based trading models."
    },
    {
      icon: LineChart,
      title: "Market Analysis",
      desc: "Continuous monitoring of price action across Equities, FX, and Crypto. We produce technical outlooks focused on market structure."
    },
    {
      icon: Trophy,
      title: "Competition Training",
      desc: "Rigorous preparation for investment challenges. We focus on risk-adjusted returns and psychology under pressure."
    }
  ];
        ...
        <main>
          ...
          <section className="relative h-screen flex flex-col justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
              <img src={TRADING_HERO_BG} alt="Trading Charts" className="w-full h-full object-cover grayscale opacity-30" />
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-8 border-l-4 border-red-600 pl-6">
                    We develop strategies, manage risk, and execute trades with discipline. The heart of the club's market activity.
                  </p>

                  <div className="flex flex-wrap gap-3">
                    {["Technical Analysis", "Global Macro", "Risk Management", "Psychology"].map((tag, i) => (
                ...
                {/* Coluna Direita: GLOBO DECORATIVO (Não interativo) */}
                <motion.div
                ...
                >
                  <div className="relative w-full max-w-[600px] aspect-square flex items-center justify-center">
                    ...
                    {/* SOMBRA COMPRIDA ATRÁS (Backlight Blur) */}
                    ...
                    <canvas
                      ...
                      style={{ 
                        width: '100%', 
                        height: '100%', 
                        opacity: 0.8, // Opacidade visual
                        transition: 'opacity 1s ease',
                        // Sombra definida no próprio elemento
                ...
                >
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                    ...
                    <div className="absolute bottom-8 left-8 text-white">
                      <p className="text-red-400 font-bold uppercase tracking-widest text-sm mb-1">Head of Trading</p>
                      <h2 className="text-4xl font-bold">David Costa</h2>
                    </div>
                  </div>
          ...
          <section className="py-24 bg-gray-50">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="text-3xl font-heading font-bold text-gray-900 mb-4">Our Methodology</h2>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Consistency comes from routine. We follow a strict process every single week.
                </p>
              </div>

              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                  { step: "01", title: "Scan & Plan", text: "Weekends are for preparation. We map key levels and news events before the market opens." },
                  { step: "02", title: "Execute & Manage", text: "We wait for price to come to us. Execution is precise, with pre-defined risk parameters." },
                  { step: "03", title: "Journal & Review", text: "Every trade is logged. We review performance weekly to plug leaks and improve edge." }
                ].map((phase, i) => (
          ...
          <section className="py-24 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  <h2 className="text-3xl font-heading font-bold text-gray-900 mb-4">Key Responsibilities</h2>
                </div>
          ...
          <section className="py-20 bg-gray-900 text-white">
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-3xl mx-auto space-y-6">
                <h2 className="text-3xl font-bold">Do you have what it takes?</h2>
                <p className="text-gray-400 text-lg">
                  We are looking for students with a passion for markets, strong analytical skills, and the discipline to learn. No prior trading experience required, but a hunger to learn is mandatory.
                </p>
                <div className="pt-4">
                  <a href="/contact" className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition-all">
                    Apply for Trading Dept <ArrowRight className="ml-2 w-4 h-4" />
                  </a>
                </div>
              </div>
            </div>
